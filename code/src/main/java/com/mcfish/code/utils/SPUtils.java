...
public final class SPUtils {
     ...
     * @param clz
     */
    public void putObject(String key, @NonNull final Class<?> clz) {
        if (TextUtils.isEmpty(key)) {
            key = clz.getSimpleName();
        }
        final String json = new Gson().toJson(clz);
        put(key, json, true);
    }
     ...
     * @param clz
     */
    public void putObject(@NonNull final Class<?> clz) {
        putObject(null, clz);
    }
     ...
     * @return
     */
    public <T> T getObject(String key, @NonNull final Class<?> clz) {
        if (TextUtils.isEmpty(key)) {
            key = clz.getSimpleName();
        }
        return (T) new Gson().fromJson(getString(key), clz);
    }
     ...
     * @return
     */
    public <T> T getObject(@NonNull final Class<?> clz) {
        return getObject(null, clz);
    }
}