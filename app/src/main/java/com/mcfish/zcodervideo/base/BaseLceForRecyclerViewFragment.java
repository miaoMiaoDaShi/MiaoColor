...
public abstract class BaseLceForRecyclerViewFragment<A extends RecyclerView.Adapter, CV extends View, M,
        V extends MvpLceView<M>,
        P extends MvpPresenter<V>> extends BaseLceFragment<CV, M, V, P> {
